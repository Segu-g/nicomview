    ...
    <Layout title="PSD アバター">
      ...
      <section>
        ...
        <p>
          ...
          フォルダに配置します。レイヤー名の先頭に特殊文字を付けることで動作を制御できます。
        </p>
        ...
        <h3>目・口フレームの構成例</h3>
        <p>
          目パチと口パクはそれぞれ最大 5 フレームのレイヤーを使用します。
...
└── body              ← 固定レイヤー`}</code>
      ...
      <section>
        ...
        <p>
          「読み込み」ボタンを押すと PSD をパースしてレイヤーツリーが表示されます。
          各レイヤーの表示/非表示の切り替えと、目・口フレームへのロール割り当てができます。
        </p>
      ...
      <section>
        ...
        <ol className="steps">
          <li>
            ...
            <br />
            VOICEVOX を起動してAPIサーバーが動作していることを確認します（デフォルト: <code>http://localhost:50021</code>）。
          </li>
          <li>
